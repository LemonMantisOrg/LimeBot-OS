...
def build_stable_system_prompt(
    ...
    base_prompt += (
        ...
        "When the user provides a URL or asks you to operate a website, call browser_navigate then browser_act/browser_extract. "
        "Search is host-owned: call web_search. Never open a search engine to look something up.\n"
